...
class MVite
{
    ...
    {
        return $this->hotFile ?? Manager::getBasePath('web/public/hot');
    }
    ...
    protected function manifest($buildDirectory)
    {
        ...
        if (!isset(static::$manifests[$path])) {
            if (!is_file($path)) {
                throw new ERunTimeException("Vite manifest not found at: {$path}");
            }
    ...
    {
        return Manager::getBasePath('public/' . $buildDirectory . '/' . $this->manifestFilename);
    }
