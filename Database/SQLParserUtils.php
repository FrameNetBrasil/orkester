...
class SQLParserUtils
{
    ...
    public const ESCAPED_BRACKET_QUOTED_TEXT = '(?<!\b(?i:ARRAY))\[(?:[^\]])*\]';
     ...
     * @return list<int>
     */
    public static function getPositionalPlaceholderPositions(string $statement): array
    {
     ...
     */
    public static function getNamedPlaceholderPositions(string $statement): array
    {
        return self::collectPlaceholders(
            $statement,
            ':',
     ...
     * @return mixed[]
     */
    public static function collectPlaceholders(
        string $statement,
        string $match,
        string $token,
        callable $collector
     ...
     * @return mixed[][]
     */
    public static function getUnquotedStatementFragments($statement)
    {
     ...
     * @throws SQLParserUtilsException
     */
    public static function extractParam($paramName, $paramsOrTypes, $isParam, $defaultValue = null)
    {
